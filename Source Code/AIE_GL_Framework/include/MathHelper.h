...
public:
	...
	mat4 GetInverse()
	{
		float  s0 = _11 * _22 - _21 * _12;
		float  s1 = _11 * _23 - _21 * _13;
		float  s2 = _11 * _24 - _21 * _14;
		float  s3 = _12 * _23 - _22 * _13;
		float  s4 = _12 * _24 - _22 * _14;
		float  s5 = _13 * _24 - _23 * _14;

		float  c5 = _33 * _44 - _43 * _34;
		float  c4 = _32 * _44 - _42 * _34;
		float  c3 = _32 * _43 - _42 * _33;
		float  c2 = _31 * _44 - _41 * _34;
		float  c1 = _31 * _43 - _41 * _33;
		float  c0 = _31 * _42 - _41 * _32;
		...
		b._11 = ( _22 * c5 - _23 * c4 + _24 * c3) * invdet;
		b._12 = (-_12 * c5 + _13 * c4 - _14 * c3) * invdet;
		b._13 = ( _42 * s5 - _43 * s4 + _44 * s3) * invdet;
		b._14 = (-_32 * s5 + _33 * s4 - _34 * s3) * invdet;

		b._21 = (-_21 * c5 + _23 * c2 - _24 * c1) * invdet;
		b._22 = ( _11 * c5 - _13 * c2 + _14 * c1) * invdet;
		b._23 = (-_41 * s5 + _43 * s2 - _44 * s1) * invdet;
		b._24 = ( _31 * s5 - _33 * s2 + _34 * s1) * invdet;

		b._31 = ( _21 * c4 - _22 * c2 + _24 * c0) * invdet;
		b._32 = (-_11 * c4 + _12 * c2 - _14 * c0) * invdet;
		b._33 = ( _41 * s4 - _42 * s2 + _44 * s0) * invdet;
		b._34 = (-_31 * s4 + _32 * s2 - _34 * s0) * invdet;

		b._41 = (-_21 * c3 + _22 * c1 - _23 * c0) * invdet;
		b._42 = ( _11 * c3 - _12 * c1 + _13 * c0) * invdet;
		b._43 = (-_41 * s3 + _42 * s1 - _43 * s0) * invdet;
		b._44 = ( _31 * s3 - _32 * s1 + _33 * s0) * invdet;
